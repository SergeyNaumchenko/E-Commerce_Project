        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>Save on premium sound for audiophiles and enthusiasts.</p>
                    <p><a class="btn btn-lg btn-primary" href="http://localhost:8000/auth/register" role="button">Sign up today</a></p>
                </div>
            </div>
        </div>
        <div class="item">
